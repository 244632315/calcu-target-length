...
data_train=np.array(data[['roll_thick','roll_width','roll_length']])#,'tcrop','hcrop'
...
data_test=np.array(data_test_pd[['roll_thick','roll_width','roll_length']])#,'tcrop','hcrop'
...
l1=add_layer(xs,3,100,activation_function=tf.nn.tanh)#tf.nn.relu
#l2=add_layer(l1,100,100,activation_function=tf.nn.tanh)#tf.nn.relu
# l3=add_layer(l2,10,10,activation_function=tf.nn.tanh)#tf.nn.relu
